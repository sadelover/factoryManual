...
双击运行DebugTool（或在factory界面上点击调试/启动调试工具），弹出如下对话框：![](/assets/BEOT打开界面.png)输入数据库所在IP地址，如果数据库就在本地，则不需要修改实时数据库登陆地址。  
...
点击点位监控，选择或搜索所需要监控的点位，双击点名，修改点值，点击确定。打开 Observer软件，便可以监控该点位。  
